...
- `config.R`: app constants and shared configuration.
- `data_loading.R`: upload parsing, file detection, and model input loading.
...
- `server.R`: Shiny server logic, reactivity, rendering, and downloads.
