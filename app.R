...
source(app_path("app_modules", "cftp.R"), local = app_env)
source(app_path("app_modules", "roi_engine.R"), local = app_env)
source(app_path("app_modules", "model_fit_plots.R"), local = app_env)
source(app_path("app_modules", "previous_model.R"), local = app_env)
